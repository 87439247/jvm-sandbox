...
import com.alibaba.jvm.sandbox.module.debug.util.beantrace.TraceConfiguration;
...
import com.alibaba.jvm.sandbox.module.debug.util.beantrace.handlers.VertexHandlers;
...
public class Container {
    ...
    public static Container make(TraceConfiguration configuration) {
        ...
        ret.vertexHandlers = new LinkedList<VertexHandler>();
